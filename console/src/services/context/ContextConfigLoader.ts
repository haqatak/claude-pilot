...
export function loadContextConfig(): ContextConfig {
  ...
  return {
    ...
    fullObservationCount: parseInt(settings.CLAUDE_PILOT_CONTEXT_FULL_COUNT, 10),
    sessionCount: parseInt(settings.CLAUDE_PILOT_CONTEXT_SESSION_COUNT, 10),
    showReadTokens: settings.CLAUDE_PILOT_CONTEXT_SHOW_READ_TOKENS,
    showWorkTokens: settings.CLAUDE_PILOT_CONTEXT_SHOW_WORK_TOKENS,
    showSavingsAmount: settings.CLAUDE_PILOT_CONTEXT_SHOW_SAVINGS_AMOUNT,
