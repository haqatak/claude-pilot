 ...
 */
export function getSummaryForSession(db: Database, memorySessionId: string): SessionSummary | null {
 ...
 */
export function getSummaryById(db: Database, id: number): SessionSummaryRecord | null {
  const stmt = db.prepare(`
 ...
 */
export function getSummariesByIds(db: Database, ids: number[], options: GetByIdsOptions = {}): SessionSummaryRecord[] {
