...
- Task → Direct tool calls (banned by workflow rules)
...
REDIRECTS = {
    ...
    "Task": {
        "message": "Task tool is BANNED (see workflow-enforcement.md)",
        "alternative": "Use Read, Grep, Glob, Bash tools directly - no sub-agents",
        "example": "Read/Grep/Glob for exploration, Bash for commands",
    },
    "EnterPlanMode": {
